...
* `ue4-source` - Whatever C++ actors/components/utilities/etc. we end up being able to easily divorce from *Steel Hunters* or, if not easily divorced, whatever seems worth divorcing so others never have to know the pain that we did. This will likely be the least frequently-updated part of the repo.
