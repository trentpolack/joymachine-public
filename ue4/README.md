...
### Materials
I tend to call master materials "shaders" (which is how I'll refer to them from now on unless I specifally talk about USF shaders) as, at least for me, they tend to be "uber-shaders" done with the material editor. Which I do primarily to differentiate between special-case materials and my general-purpose shaders.
...
![My UE4 standard shader/material](https://joy-machine.com/wp-content/gallery/steel-hunters-dev-shots/2016_11_03_really_whats_so_complex.PNG)
...
![A random material instance](https://joy-machine.com/wp-content/gallery/steel-hunters-dev-shots/dev_shot_example_random_material_instance.PNG)

And a material instance created from my standard shader:

![A material instance of my standard shader](https://joy-machine.com/wp-content/gallery/steel-hunters-dev-shots/dev_shot_example_shader_material_instance.PNG)
